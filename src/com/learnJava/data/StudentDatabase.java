...
public class StudentDatabase {
    ...
    public static Supplier<Student> supplier = () -> new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"),5);
    /**
    ...
    public static List<Student> getAllStudents(){
        ...
        Student student4 = new Student("Dave",3,3.9,"male", Arrays.asList("swimming", "gymnastics","soccer"), 19);
        /**
         * 4th grade students
         */
        Student student5 = new Student("Sophia",4,3.5,"female", Arrays.asList("swimming", "dancing","football"),33);
